...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#f7f7f7]  pt-10 border-t-2 border-[#e0dede7a] ">
      <div className="w-[98%] md:w-[90%] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 gap-y-8">
        <section>
          ...
          <p className="text-[17px] ">{t("footer.brandDescription")}</p>
        </section>
        <section>
          <h2 className="text-xl font-medium mb-5">{t("footer.quickLinksTitle")}</h2>
