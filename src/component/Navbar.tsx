...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full py-4 bg-[#f7f7f7] flex justify-between items-start md:items-center pt-7 px-2 sm:px-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-7 md:gap-16">
        <div  className="flex items-center justify-center sm:justify-end gap-2 sm:gap-7 cursor-pointer sm:w-[300px] md:w-[400px] lg:w-[600px] ">
          <div onClick={()=>setContentPage("homes")} className="flex items-center gap-1 relative overflow-hidden group">
            <img loading="lazy" src={image} alt="Homes" width={35} height={35} className="group-hover:scale-110 pb-2  transition-all duration-300"/>
          ...
          <div onClick={()=>setContentPage("departments")} className="flex  items-center gap-1 relative overflow-hidden group cursor-pointer ">
            <img loading="lazy" src={image} alt="Homes" width={35} height={35} className="group-hover:scale-110 pb-2 h transition-all duration-300" />
