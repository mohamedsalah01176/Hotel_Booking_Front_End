...
const DashboardLinks = () => {
  ...
  return (
    <div  className="flex items-center justify-center gap-2 sm:gap-7 cursor-pointer sm:w-[350px] ">
      <NavLink to="addListing"  className="flex items-center gap-1 relative overflow-hidden group py-1">
      ...
      <NavLink to="listings" className="flex  items-center gap-1 relative overflow-hidden group cursor-pointer py-1">
      ...
      <NavLink to="customers"  className="flex  items-center  gap-1 relative overflow-hidden group cursor-pointer py-1 ">
