            ...
            <div className="flex z-50 flex-col sm:flex-row justify-between items-center gap-2 sm:gap-7 md:gap-16">
              <div  className="flex items-center justify-center gap-2 sm:gap-7 cursor-pointer sm:w-[350px] ">
                <NavLink to="/dashboard"  className="flex  items-center  gap-1 relative min-w-fit overflow-hidden group cursor-pointer py-1 ">
                  ...
                  <div className={`h-[3px] w-full bg-gray-700 absolute bottom-0 ${url.pathname === "dashboard" ?"left-0":"-left-44"}  group-hover:left-0 transition-all duration-300`}></div>
                </NavLink>
                <NavLink to="addListing"  className="flex items-center gap-1 relative min-w-fit overflow-hidden group py-1">
                  ...
                  <div className={`h-[3px] w-full bg-gray-700 absolute bottom-0 ${url.pathname.includes("addListing") ?"left-0":"-left-44"} group-hover:left-0 transition-all duration-300`}></div>
                </NavLink>
