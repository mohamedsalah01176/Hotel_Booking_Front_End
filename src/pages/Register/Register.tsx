  ...
  const formik=useFormik({
    ...
    onSubmit:async(values)=>{
      ...
      try{
        ...
        toast.error(errors.response.data.message || t("register.messages.somethingWentWrong") )
      }
    }
  })
    ...
    <div className="min-h-[90vh] flex flex-col md:flex-row justify-center items-center gap-14 px-10">
      ...
      <form onSubmit={formik.handleSubmit} className="w-[300px] md:w-[400px] mt-[120px] md:mt-0" >
        ...
        <div className="flex flex-col gap-1 mt-3">
          <label className={`text-lg font-normal ${formik.touched.name && formik.errors.name && "text-red-600"}`} htmlFor="name">{t("register.labels.fullName")}</label>
        ...
        <div className="flex flex-col gap-1 mt-3">
          <label className={`text-lg font-normal ${formik.touched.phone && formik.errors.phone && "text-red-600"}`} htmlFor="phone">{t("register.labels.phone")}</label>
        ...
        <div className="flex flex-col gap-1 mt-3">
          <label className={`text-lg font-normal ${formik.touched.email && formik.errors.email && "text-red-600"}`} htmlFor="email">{t("register.labels.email")}</label>
        ...
        <div className="flex flex-col gap-1 mt-3">
          <label className={`text-lg font-normal ${formik.touched.password && formik.errors.password && "text-red-600"}`} htmlFor="password">{t("register.labels.password")}</label>
